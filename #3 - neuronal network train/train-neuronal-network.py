...
print("noOfClasses: " + str(noOfClasses))
for x in range (0,len(myList)):
    myPicList = os.listdir(path+"/"+str(count))
    for y in myPicList:
        pic_path = path+"/"+str(count)+"/"+y
...
for i in range(cols):
    ...
    for j,row in data.iterrows():
        ...
        print("x_selected: " + str( x_selected))

        rand_number = random.randint(0, len(x_selected)- 1)
        print("rand_number: " + str(rand_number))

        rand_x_selected = x_selected[rand_number, :, :]
        print("rand_x_selected" + str(rand_x_selected))

        axs[j][i].imshow(rand_x_selected)
        axs[j][i].axis("off")
        if i == 1:
...
range_classes = range(0, num_classes)
print("range_classes: " + str(range_classes))
print("num_of_samples: " + str(num_of_samples))

plt.bar(range_classes, num_of_samples)
