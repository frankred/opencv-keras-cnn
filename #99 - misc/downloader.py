...
key = 'e302c745b2ffab9cab50213639c054db'  # Flickr API key https://www.flickr.com/services/apps/create/apply
secret = '35a62ea692a05432'


def get_urls(search='honeybees on flowers', n=10, download=True):
